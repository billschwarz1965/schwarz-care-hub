...
const DISEASES = [
  {
    ...
    treatmentLandscape: [
      { category: "Topical", agents: ["Corticosteroids", "Calcineurin inhibitors", "Eucrisa (crisaborole) — PDE4 inhibitor", "Opzelura (ruxolitinib) — topical JAK inhibitor"] },
      { category: "Biologic — IL-4/IL-13", agents: ["★ Dupixent (dupilumab) — IL-4Rα blocker, first-line biologic", "Adbry (tralokinumab) — IL-13 targeted, ages 12+", "Ebglyss (lebrikizumab) — IL-13, moderate-to-severe"] },
      { category: "Biologic — Other", agents: ["Nemluvio (nemolizumab) — IL-31R, targets itch/lesions"] },
      { category: "Oral JAK inhibitors", agents: ["Rinvoq (upadacitinib) — AbbVie, daily oral", "Cibinqo (abrocitinib) — Pfizer, daily oral, JAK1-selective"] },
    ],
    competitivePosition: "Dupixent is the market leader with the broadest label (ages 6mo+), strongest long-term safety data (3+ years), and no lab monitoring requirement. JAK inhibitors (Rinvoq, Cibinqo) offer rapid itch relief but carry boxed warnings for MACE, malignancy, and thrombosis. Adbry and Ebglyss compete on the IL-13 axis but lack Dupixent's cross-disease platform. JADE DARE showed comparable EASI-75 but Dupixent had superior safety profile.",
  ...
  },
  {
    ...
    treatmentLandscape: [
      ...
      { category: "Biologic — Type 2", agents: ["★ Dupixent (dupilumab) — IL-4Rα, broad type 2 coverage", "Tezspire (tezepelumab) — TSLP, phenotype-independent (AstraZeneca)", "Xolair (omalizumab) — IgE, allergic asthma (Genentech/Novartis)"] },
      { category: "Biologic — Anti-IL-5", agents: ["Nucala (mepolizumab) — IL-5 (GSK)", "Fasenra (benralizumab) — IL-5Rα (AstraZeneca)"] },
      { category: "Pipeline", agents: ["Itepekimab (IL-33)", "Astegolimab (IL-33)"] },
    ],
    competitivePosition: "Dupixent is the only biologic blocking both IL-4 and IL-13 in asthma, addressing the broadest type 2 biology. Anti-IL-5s (Nucala, Fasenra) target eosinophils only. Tezspire is phenotype-agnostic but newer with less long-term data. Xolair is limited to allergic/IgE-high phenotypes. Dupixent uniquely reduces both exacerbations and OCS dependence across type 2 biomarker levels.",
  ...
  },
  {
    ...
    treatmentLandscape: [
      ...
      { category: "Biologic", agents: ["★ Dupixent (dupilumab) — IL-4Rα, first FDA-approved biologic for CRSwNP", "Xolair (omalizumab) — IgE (Genentech/Novartis)", "Nucala (mepolizumab) — IL-5 (GSK)"] },
      { category: "Surgical", agents: ["Endoscopic sinus surgery (ESS)"] },
    ],
    competitivePosition: "Dupixent was the first biologic approved for CRSwNP and has the strongest polyp reduction and smell improvement data. Xolair and Nucala are approved but with narrower efficacy profiles. Dupixent's dual IL-4/IL-13 blockade addresses the full type 2 inflammatory cascade driving polyp formation.",
  ...
  },
  {
    ...
    treatmentLandscape: [
      ...
      { category: "Biologic (emerging)", agents: ["★ Dupixent (dupilumab) — IL-4Rα, Phase 3 BOREAS/NOTUS positive", "Fasenra (benralizumab) — IL-5Rα (AstraZeneca)", "Tezspire (tezepelumab) — TSLP, investigational (AstraZeneca)"] },
    ],
    competitivePosition: "Dupixent is first-to-market with positive Phase 3 data (BOREAS, NOTUS) in type 2 high COPD — a major unmet need with no approved biologics. Benralizumab and tezepelumab are in trials but Dupixent has the clearest regulatory path. The type 2 high COPD segment (~30-40% of patients) represents a significant expansion opportunity.",
  ...
  },
  {
    ...
    treatmentLandscape: [
      ...
      { category: "Biologic", agents: ["★ Dupixent (dupilumab) — IL-4Rα, first biologic approved for PN", "Nemluvio (nemolizumab) — IL-31Rα, targets itch pathway (Galderma, approved 2024)"] },
      { category: "Neuromodulators", agents: ["Gabapentin", "SSRIs", "Naltrexone"] },
    ],
    competitivePosition: "Dupixent was first-to-market in PN. Nemolizumab (Nemluvio) targets IL-31-mediated itch specifically and gained approval in 2024, representing the primary biologic competitor. Dupixent addresses the broader type 2 inflammatory cascade while nemolizumab focuses on the itch-scratch cycle via a different mechanism.",
  ...
  },
  {
    ...
    treatmentLandscape: [
      ...
      { category: "Biologic", agents: ["Xolair (omalizumab) — IgE, established standard (Genentech/Novartis)", "★ Dupixent (dupilumab) — IL-4Rα, approved 2024 for CSU"] },
      { category: "Other", agents: ["Cyclosporine", "Ligelizumab (anti-IgE — Novartis, investigational)"] },
    ],
    competitivePosition: "Xolair was the first biologic in CSU and remains the established standard. Dupixent's 2024 approval provides a second biologic option, particularly for patients who are inadequate responders to omalizumab. The dual IL-4/IL-13 mechanism addresses autoimmune IgE-mediated and type 2 components of CSU.",
