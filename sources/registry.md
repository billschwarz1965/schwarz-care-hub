...
| ID | Title | Path | Updated | Notes |
|----|-------|------|---------|-------|
| MTG-001 | ADVENT 2-Day Workshop — consolidated summary | `Meeting Notes and Agendas/Notes/MedVerse_Advent_Workshop_2Day_Consolidated_Summary_July_2026.html` | 2026-07 | Decisions, actions, parking lot |
| MTG-002 | ADVENT Workshop — Day 1 notes | `Meeting Notes and Agendas/Notes/Advent Day 1/` | 2026-07-13 | MD + HTML + transcript |
| MTG-003 | ADVENT Workshop — Day 2 notes | `Meeting Notes and Agendas/Notes/Advent Day 2/` | 2026-07-14 | MD + HTML + deck + photos |
| MTG-004 | Workshop agenda | `Meeting Notes and Agendas/Agendas/MedVerse_Advent_Workshop_Agenda_July_2026.md` | 2026-07 | Pre-workshop |
...
| ID | Title | Path | Updated | Notes |
|----|-------|------|---------|-------|
| FIN-001 | FY26 Budget Summary | `PMO/Business Case artifacts/FY26_Budget_Summary.md` | 2026 | |
| FIN-002 | Digital spend / SOWs | `Digital Spend and SOWs/` | Ongoing | Vendor contracts |
| FIN-003 | Executive business case deck | `MedVerse Executive Business Case - Updated Phase Plan v2.1.pptx` | 2026 | Root folder |
...
| ID | Title | Path | Updated | Notes |
|----|-------|------|---------|-------|
| GOV-001 | Principles of Scientific Engagement | `Governance/Principles of Scientific Engagement.url` | — | SharePoint |
| GOV-002 | Content Dissemination Playbook | `Governance/Content Dissemination Plans/Playbook - Content Dissemination Plan.url` | — | SharePoint |
| GOV-003 | MedVerse Requirements v2 | `Business Requirements/MedVerse Requirements v2.xlsx.url` | — | SharePoint |
| GOV-004 | SEO/GEO/AEO resources | `Research & Benchmarking/SEO-GEO-AEO Resources/` | Ongoing | Discoverability standards |
...
| ID | Title | Path | Updated | Notes |
|----|-------|------|---------|-------|
| RES-001 | HCP Knowledge Repository | `Research & Benchmarking/HCP Existing Knowledge/Knowledge Repository.pdf` | — | |
...
## Operational portals (live — do not duplicate)

| ID | Title | Path | Status |
|----|-------|------|--------|
| WS-000 | MedVerse Platform Hub | `Meeting Notes and Agendas/Notes/MedVerse Hub/` | Active |
| WS-001 | ADVENT Integration | `Meeting Notes and Agendas/Notes/ADVENT MedVerse Integration Workstream/` | Active |
| WS-002 | Platform & Experience | `Meeting Notes and Agendas/Notes/Platform & Experience Workstream/` | Forming |
| WS-003 | Analytics & Measurement | `Meeting Notes and Agendas/Notes/Analytics & Measurement Workstream/` | Forming |
| WS-004 | Content & AI Discoverability | `Meeting Notes and Agendas/Notes/Content & AI Discoverability Workstream/` | Forming |
| WS-005 | Governance & Rollout | `Meeting Notes and Agendas/Notes/Governance & Rollout Workstream/` | Planned |
| WS-006 | Change & Adoption | `Meeting Notes and Agendas/Notes/Change & Adoption Workstream/` | Planned |
| WS-007 | Program Migration | `Meeting Notes and Agendas/Notes/Program Migration Workstream/` | Planned |

---

## Adding a new source

1. Assign the next ID in the appropriate section (e.g. `MTG-008`).
2. Fill: Title, Path, Updated, Owner/Notes.
3. If authoritative facts changed, update `knowledge-base/MedVerse_Operating_System.csv`.
4. Commit with message: `Register [ID]: [short title]`.
